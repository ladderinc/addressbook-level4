...
it also comes with some of the features from the AB4 project.
...
*** Did tweaks to ReadMe, UserGuide and DeveloperGuide to meet the module requirements. (Pull Requests https://github.com[#12], https://github.com[#14], https://github.com[#23])
